...
static NSString *const kBioAuthMonitorZtechExitSDK = @"ztech_exit";
...
static NSString *const kBioAuthUploadEnd = @"imageUploadEnd";
...
static NSString *const kBioAuthUploadStart = @"imageUploadStart";
...
#pragma mark - 秘钥轮转相关
static NSString *const kAPBKeyHash = @"ZLZKeyHash";
static NSString *const kAPBC2SPubKey = @"ZLZC2SPubKey";
...
static NSString *const KAPBGWUseJSONRPC = @"usejsonrpc";
