...
//NSInteger转成NSString
#define IntegerToString(integer)    [NSString stringWithFormat:@"%lu", (unsigned long)integer]
...
+ (UIImage*)imageFromName:(NSString*)imageName bundlePath:(NSString *) bundlePath;

+ (UIColor*)colorFromString:(NSString *)string;

+ (BOOL)checkSig:(NSData *)content
             sig:(NSData *)signature
