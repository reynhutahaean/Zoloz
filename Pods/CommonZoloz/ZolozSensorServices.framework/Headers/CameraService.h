...
- (BOOL) lockFocus:(nullable void (^)(CMTime syncTime))handler;
- (void) lockWhiteBalanceAndExposure;
- (void) unlockWhiteBalanceAndExposure;

- (BOOL)setWhiteBalanceMode:(AVCaptureWhiteBalanceMode)mode;
- (BOOL)setWhiteBalanceGains:(AVCaptureWhiteBalanceGains)gains completionHandler:(nullable void (^)(CMTime syncTime))handler;

@property (atomic, readonly) float deviceISO;
@property (atomic, readonly) CMTime deviceExposureDuration;
- (BOOL)setExposureMode:(AVCaptureExposureMode)mode;
- (BOOL)setExposureModeCustomWithDuration:(CMTime)exposureDuration ISO:(float)iso completionHandler:(nullable void (^)(CMTime syncTime))completionHandler;
- (BOOL)setExposureModeContinuousAutoWithBias:(float)bias completionHandler:(nullable void (^)(CMTime syncTime))completionHandler;
